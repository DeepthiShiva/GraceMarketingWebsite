	...
	<section class="page-header">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="content">
						<h1 class="page-name">View Product</h1>
						<ol class="breadcrumb">
	...
	<div class="box">
		...
		<div>
			<img src="data:image/jpeg;base64,${imgBase}"
				style="height: 150px; margin-left: auto; margin-right: auto; width: 50%; display: block;" />
		</div>
		<p>
			Stock : <b><%=resultSet.getString("stock")%></b>
		</p>
		...
		<%-- <p style="color:black;">
			<%=resultSet.getString("productDesp")%>
			
		</p>
		<p>
			<%=resultSet.getString("productRecom")%>

...
<body id="body">
	...
	<section class="about section">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<img class="img-responsive" src="img/oil.jpg">
				</div>
				<div class="col-md-6">
					<h2 class="mt-40">About Our Shop</h2>
					<p>Grace Marketing is the authorized Tamil Nadu Distributor for
						Automotive and Indiustial Lubricants. We are dealing with TATA
						Autocomp Lubricants, 99 Lubricants and Champol Lubricants. We
						started in the year 2016 and trading all over Tamil Nadu.</p>
					<p>We are also expecting experienced dealers from each district
						to do business with us.</p>
					<p>Engine oils, Gear oils, Coolants, Hydraulics, Power
						steering, Radiator coolants, Grease, Marine oils, Synthetic and
						semi synthetic oils, Diesel Exhaust Fluids, Filters and all type
						of industrial oils available with us.</p>

					<h2>Mission</h2>
					<p>Differentiation through Safety, Quality and Constant
						Innovation</p>

...
<body id="body">
	...
	<form name="cart_form" action="CartPageServlet" method="post">
							...
							<div class="block">
								<div class="product-list">
									<form action="CartPageServlet" method="post">
												...
												<tr class="">
													<td class="">
														<div class="product-info">
															<img width="80" src="data:image/jpeg;base64,${imgBase}"
																alt="" /> <a href="#!"><%=productResult.getString("productName")%></a>
														</div>
													</td>
													<td class=""><%=productPrice%></td>
													<td class=""><input type="number" id="quantity"
														name="<%=productId%>" min="1" max="<%=stock%>" required></td>
													<td class="">
														<button type="button" class="curve"
															onclick="window.location.href = 'deleteCart.jsp?productId=<%=productId%>';">Delete</button>
													</td>
												</tr>
										...
										<a href="ProceedToBuy.jsp">
											<button type="submit" class="btn btn-main pull-right">Checkout</button>
										</a>
